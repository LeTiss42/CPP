...
/*   Updated: 2023/03/22 01:12:30 by mravera          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap( void ) : _name("DefaultClap"), _hp( 10 ), _ep( 10 ), _ad( 0 ) {
...
void	ClapTrap::beRepaired( unsigned int amount ) {
	...
	if (( this->_hp > 0 ) && ( this->_ep > 0 ))
	{
		...
		std::cout << "ClapTrap " << this->_name << " can't repair himself because he's dead..." << std::endl;
	else if (this->_ep <= 0)
		std::cout << "ClapTrap " << this->_name << " has not enough energy points to repair himself..." << std::endl;
	return ;
}
